            ...
            <Content>
                {loading ? (
                    ...
                    <>
                        ...
                        {challengeModalOpen && (
                            <ChallengeModal challenges={challenges} stageIndex={selectedStage} onClose={closeModal} onReset={handleReset} />
                        )}
                        ...
                        {rewardModalOpen && (
                            <Modal
                                ...
                                icon={CoinIcn}
                                score="+20"
                                buttons={[{ label: "확인", onClick: () => setRewardModalOpen(false) }]}
                            />
                        )}
                        ...
                        {doneModalOpen && (
                            <Modal
                                ...
                                buttons={[{ label: "확인", onClick: () => setDoneModalOpen(false) }]}
                            />
                        )}
                    </>
                )}
