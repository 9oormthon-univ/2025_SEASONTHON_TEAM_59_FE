        ...
        <FlexBox>
          <StatContainer>
            ...
            <DashInfo>
              ...
              <InnerValue>
                {Number.isFinite(stats.totalMemberCount)
                  ? `${stats.totalMemberCount.toLocaleString()}명`
                  : "0명"}
              </InnerValue>
            </DashInfo>
            <DashInfo>
        ...
        <EnvCon>
          <TopMargin>
            <DashProtected>
              <ImgCon as="img" src={DashButtonImg} alt="대시버튼 컨테이너" />
              <InnerText>
                {Number.isFinite(stats.treesPlantedEffect)
                  ? `${stats.treesPlantedEffect.toLocaleString()}그루`
                  : "0 그루"}
              </InnerText>
